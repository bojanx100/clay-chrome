(function (root) {
  ...
  function create(options) {
    ...
    shadow.innerHTML = "<style>" + styles() + "</style>" +
      ...
      '<div class="composer"><div class="compose-row"><textarea rows="2" ' +
